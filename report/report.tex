...
%TODO(heylook): Explicitly mention that we don't/can't use content information for recommendations. Only meta data.
...
%TODO(?): Talk about why or how we care about RMSE.
