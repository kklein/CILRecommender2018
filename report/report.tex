...
The goal is to predict $ \widehat{ \mathcal{R}}$ where  $\widehat{r}_{i'j'} \in \widehat{\mathcal{R}} \rightarrow \hat r_{ij} \not\in \mathcal{R}$. 
...
\begin{equation}
RMSE = \sqrt{\frac{1}{|T|}\sum_{(u, i) \in T} (y_{u,i} -\widehat{y}_{u,i})^2}    
\end{equation}
